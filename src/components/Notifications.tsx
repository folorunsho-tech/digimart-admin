  ...
  return (
    <>
      ...
      {display === "notifications" && (
        <div className="cursor-pointer absolute top-14 bg-gray-100 z-50 w-72 h-auto shadow-sm rounded-sm font-semibold border-t-2 pt-2 divide-y-2 overflow-y-auto divide-gray-400">
